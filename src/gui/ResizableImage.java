...
public class ResizableImage {
	private String defaultPath = new JFileChooser().getFileSystemView()
			.getDefaultDirectory().toString()+File.separator+"tests"+File.separator;
    ...
    public ResizableImage() {
                ...
                try {
                    BufferedImage image = ImageIO.read(new File(defaultPath+"003_by_torati-d5x4yna.jpg"));

                    Frame main = null;
                    JDialog frame = new JDialog(main, "Test");
                    frame.setDefaultCloseOperation(JDialog.DISPOSE_ON_CLOSE);
                    frame.setLayout(new BorderLayout());
                    frame.add(new ScalablePane(image), BorderLayout.CENTER);
                    frame.pack();
